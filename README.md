...
Automatisierte Tests im Headless-Chromium mit simuliertem Google-Login und simuliertem Drive/YouTube/Spotify/lyrics.ovh/LRCLIB/Mikrofon (**≈458 Prüfungen**; Ausführung über `localhost`, teils mit Handy-Emulation: Viewport, Touch, Pixelverhältnis). Stand v2.6.0: alle bestanden bis auf 3 Prüfungen im älteren Offline/Sync-Test (Konflikt bei Strichen), die in dieser Testumgebung genauso mit der unveränderten v2.4.0 fehlschlagen – der lokal gezeichnete dritte Strich kommt dort im Test gar nicht erst zustande; das Zusammenführen selbst (Notizen beider Geräte, fremder Strich) funktioniert. Nicht durch v2.5.0/v2.6.0 verursacht, aber vorgemerkt.
