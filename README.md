...
Automatisierte Tests im Headless-Chromium mit simuliertem Google-Login und simuliertem Drive/YouTube/Spotify/lyrics.ovh/LRCLIB/Mikrofon (**≈680 Prüfungen** in 23 Testdateien; Ausführung über `localhost`, teils mit Handy-Emulation: Viewport, Touch, Pixelverhältnis). Stand v2.8.4: **alle bestanden.** Die 3 früher fehlschlagenden Prüfungen im Offline/Sync-Test (Konflikt bei Strichen) lagen am Test selbst: Seit der zweiten Menüleiste lag die Stelle, an der der Test zeichnet, unter dem Notizfeld. Der Test scrollt jetzt vorher, alle 25 Prüfungen bestehen. Die App war nicht betroffen.
