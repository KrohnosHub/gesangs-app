...
- **Mitspielen mit YouTube-Link (ab v2.3.2):** In dieser Umgebung ist kein Netzwerkzugriff auf YouTube möglich, daher nur die Bedienoberfläche (Auswahl, Vorauswahl Karaoke, Ein-/Ausblenden) automatisiert geprüft, nicht das tatsächliche Laden/Abspielen des YouTube-Players oder die Synchronität zum Aufnahmestart. Bitte einmal mit echtem Internetzugang ausprobieren – insbesondere ob das Video beim Start der Aufnahme zuverlässig automatisch abspielt (Browser blockieren automatisches Abspielen teils, v. a. auf dem Handy) und ob Ton hörbar ist.
- **Stift-Strich-Sichtbarkeit auf dem Handy (Samsung Internet u. a.):** Der Fixversuch in v2.3.2 (Zeitlimit statt reinem `requestAnimationFrame`) liess sich mangels des betroffenen Geräts in dieser Umgebung nicht verifizieren – bitte auf dem echten Handy testen und zurückmelden.
